...
#define MSG_NAVIGATE2	(WM_USER+1001)
#define MSG_RESIZE		(WM_USER+1002)
#define MSG_REFRESH		(WM_USER+1003)
#define MSG_GOHOME		(WM_USER+1004)
#define MSG_GOFORWARD	(WM_USER+1005)
#define MSG_GOBACK		(WM_USER+1006)
#define MSG_SETFOCUS 	(WM_USER+1007)
#define MSG_EXECSCRIPT 	(WM_USER+1008)
  ...
  (JNIEnv *pEnv, jobject pObj, jstring javaScript)
{
	...
	const char *javaScriptStr	= pEnv->GetStringUTFChars(javaScript, 0);
   ThreadParam *pThreadParam = new ThreadParam;
   pThreadParam->script = javaScriptStr;
...
//#endif
	...
	pEnv->ReleaseStringUTFChars(javaScript, javaScriptStr);
}
